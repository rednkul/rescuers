...
from .views import WorkersView, Search, WorkerFilterView, WorkerDetailView, NewWorkerView, EditWorkerView, \
    ...
    ServiceEditView, PostDetailView, PostStateDetailView, PostStateEditView, NewServiceView, DeletePostView, ServiceDeleteView
...
urlpatterns = [
    ...
    path('services/<int:pk>/delete_service/', login_required(ServiceDeleteView.as_view()), name='delete_service'),
